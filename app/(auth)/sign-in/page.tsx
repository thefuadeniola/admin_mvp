        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            <div className="grid w-full items-center gap-6">
              ...
              <div className="flex flex-col space-y-3">
                <Label htmlFor="name" className='font-thin w-full flex flex-row justify-between'><span>Password</span><span className='text-primary-blue text-xs'>Forgot Password?</span></Label>
